  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-gray-100">
        <h1 className="text-3xl md:text-4xl font-bold mb-2 text-primary text-center tracking-tight">
          Privacy Policy
        </h1>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">We collect this information:</p>
            <ul className="list-disc list-inside mb-3">
              <li className="mb-2">
            ...
            <h3 className="text-xl font-semibold text-primary mb-2 mt-4">
            ...
            <p className="mb-3 leading-relaxed">
              As with many other websites and mobile applications, as you navigate
              through and interact with our Website or the App, we may use
            ...
            <ul className="list-disc list-inside mb-3">
              <li className="mb-2">
                Details of your visits to our Website or the App, including
                traffic data, location data, logs, language, date and time of
                access, frequency, and other communication data and the resources
                that you access and use on the Website or the App.
              </li>
              <li className="mb-2">
                Information about your computer and internet connection,
                including your IP address, operating system, host domain, and
                browser type.
              </li>
              <li>
                Details of referring websites (URL). We also may use these
                technologies to collect information about your online activities
                over time and across third-party websites or other online services
                (behavioral tracking).
              </li>
            </ul>
            <p className="mb-3 leading-relaxed">
              ...
              with personal information you provide to us or that we collect in
              other ways or receive from third parties. It helps us to improve our
              Website or the App and to deliver a better and more personalized
            ...
            <ul className="list-disc list-inside mb-3">
              ...
              <li className="mb-2">
                ...
                our Website or the App according to your individual interests.
              </li>
            ...
            <p className="mb-3 leading-relaxed">
              Our Website and the App uses two types of cookies: single-session
              (temporary) and multi-session (persistent). Temporary cookies last
              only as long as your web browser is open, and are used for technical
              purposes such as enabling better navigation through our Website or
              the App. Once you close your browser, the cookie disappears.
              Persistent cookies are stored on your computer for longer periods
              and are used for purposes including tracking the number of unique
              ...
              “pixel tags”) that allow us to know when you visit our Website or
              the App. Through pixel tags, we obtain non-personal information or
              aggregate information that can be used to enhance your online
              experience and understand traffic patterns.
            </p>
            <h3 className="text-xl font-semibold text-primary mb-2 mt-4">
            ...
            <p className="mb-3 leading-relaxed">
              ...
              websites we operate or the other services we provide. We are working
              closely with third parties (including, for example, third parties
              intermediaries, such as the physicians, medical professionals, and
              pharmacies with whom we contract to provide you with services,
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">
              We may use information collected about you, including personal
              information, in the following ways:
            </p>
            <ul className="list-disc list-inside mb-3">
              <li className="mb-2">
                To provide you with information that you have requested or to
                respond to your inquiries, to provide you with care and to run
                our healthcare operations.
              </li>
              <li className="mb-2">
                To carry out the services and communicate with healthcare
                organizations and medical professionals, and to provide you with
                the information, products and services that you request from us.
              </li>
              <li className="mb-2">
                To provide you with technical support and to improve our Website,
                our App, and services.
              </li>
              <li className="mb-2">
                In order to ensure that content from our Website and the App is
                presented in the most effective manner for you and for your
                computer or mobile phone, to allow you to participate in
                interactive features of our service (when you choose to do so),
                and as part of our efforts to keep our site safe and secure.
              </li>
              <li className="mb-2">
                To communicate with you about our products and services and those
                of our subsidiaries, affiliates, and parent companies and any of
                their related businesses and those of our third-party partners.
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                ...
                transfer of substantial assets, reorganization, or liquidation, we
                may transfer, sell, or assign to third parties information
                concerning your relationship with us, including, without
                limitation, personal information that you provide and other
                information concerning your relationship with us.
              </li>
              <li className="mb-2">
                To notify you about changes to our service or our Website or the
                App.
              </li>
              <li className="mb-2">
                For any purpose where you have given your consent (where legally
                required).
              </li>
              <li>To comply with applicable federal and state law.</li>
            </ul>
            <p className="mb-3 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">
              You agree that we have the right to disclose personal information
              that we collect or you provide as described in this privacy policy:
            </p>
            <ul className="list-disc list-inside mb-3">
              <li className="mb-2">
                To any member of our group, which means our subsidiaries and
                affiliates, including our ultimate holding company and its
                subsidiaries.
              </li>
              <li className="mb-2">
                To healthcare organizations, medical professionals, pharmacies,
                ...
                support of the activities noted above.
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                ...
                select and serve relevant advertisements to you and others. We do
              ...
              <li className="mb-2">
                ...
                you email us asking us to contact a third party (including a
                medical professional), we may transmit the contents of your email
                to the recipient.
              </li>
              <li className="mb-2">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mb-3">
              <li className="mb-2">
                ...
                are being sent. If you disable or refuse cookies, please note
                that some parts of this site may then be inaccessible or not
                function properly.
              </li>
              <li className="mb-2">
                Do Not Track. We do not currently respond to “do not track”
                signals as we do not track our customers across third party
                websites.
              </li>
              <li className="mb-2">
                ...
                purposes by contacting us. If we have sent you a promotional
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">
              ...
              processing was based on your consent) and there is no other legal
              ground for the processing; when you object to the processing and
              there are no overriding legitimate grounds for the processing; when
              your personal information has been unlawfully processed; and when it
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">
              ...
              password with anyone. The information you share in public areas may
              be viewed by any user of the Website or the App.
            </p>
            <p className="mb-3 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">
              ...
              the age of 13. If we learn we have collected or received personal
              ...
              under the age of 13, please contact us to request access to,
          ...
          <section>
            ...
            <ul className="list-disc list-inside mb-3">
              ...
              <li className="mb-2">
                <strong>Curexa (EHT Pharmacy LLC)</strong>
                <br />
              ...
              <li className="mb-2">
                <strong>Ridgeway Pharmacy</strong>
                <br />
                2824 US-93
                <br />
                Victor, MT 59875
              ...
              <li>
                <strong>Priority Care Pharmacy</strong>
                <br />
                5902 Van Nuys Blvd
                <br />
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">
              We reserve the right to change this privacy policy at any time. It
              is our policy to post any changes we make to our privacy policy
              posted on this page. The date this privacy policy was last revised
              ...
              for you, and for periodically monitoring and reviewing any updates
              to the privacy policy. Your continued use of our Website or the App
              after such amendments will be deemed your acknowledgement of these
          ...
          <section>
            ...
            <ul className="list-disc list-inside mb-3">
              <li className="mb-2">
                Right to obtain a copy of your information. We are allowed to
                charge you a fee if we think it's appropriate.
              </li>
              <li>
                Right to an accounting of the disclosure of your information. You
                are entitled to one 'disclosure accounting' in a 12 month period
                at no charge. An accounting does not include disclosures to carry
                out treatment, healthcare operations or payment. We are allowed to
                charge a fee for any additional accounting in a 12 month period.
              </li>
            </ul>
          </section>
        </div>
