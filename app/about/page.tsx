...
export const metadata: Metadata = generateSEO({
  title: "About Powerpill | Licensed Online Pharmacy for ED Medications",
  description: "Learn about Powerpill, a licensed online pharmacy specializing in erectile dysfunction medications. Licensed physicians, FDA-approved medications, and discreet shipping.",
  keywords: pageKeywords.about,
  canonical: "https://powerpill.us/about",
})
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">About Powerpill</h1>
          
          <div className="space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Our Mission</h2>
              <p className="text-gray-600 leading-relaxed">
                Powerpill is dedicated to providing safe, effective, and affordable erectile dysfunction 
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-600 mt-2">Phone: 1 (800) 692-1890</p>
                <p className="text-gray-600">Email: support@powerpill.us</p>
              </div>
            </section>
          </div>
        </div>
