            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="text-gray-600">
                  At Powerpill, we understand that men's health is a sensitive topic. That's why we've created a discreet, convenient, and affordable way to access FDA-approved medications for erectile dysfunction.
                </p>
                <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 italic mb-4">
                "After trying several options, Sildenafil from Powerpill has been the most effective for me. The ordering process was simple and the discreet packaging was much appreciated."
              </p>
