...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  if (!product) {
    return {
      title: "Product Not Found | Powerpill",
      description: "The requested product was not found.",
    }
  }

  return {
    title: `${product.name} | Buy Online | $${product.price} | Powerpill`,
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://powerpill.us${product.image}`,
          width: 800,
          height: 600,
          alt: product.name,
        },
    ...
    alternates: {
      canonical: `https://powerpill.us/products/${product.id}`,
    },
  }
}
